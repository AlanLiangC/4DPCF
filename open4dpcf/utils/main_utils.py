...
def get_dataset(dataname, config):
    ...
    from open4dpcf.datasets import load_data
    config['data_config'].update(dataset_parameters[dataname][config['forecasting_time']])
    return load_data(dataname, config)
