...
from .common import KittiPoint2nuScenes, KittiPoints2nuScenes
...
class KittiOd_Dataset(Dataset):
    ...
    def __init__(self, kitti_root, kitti_split, **kwargs):
...
def load_data(**kwargs):
    kitti_root = kwargs.pop('data_root')

    dataloader_train = create_loader(KittiOd_Dataset(kitti_root, kitti_split='trainval', **kwargs),
                                    shuffle=True,
                                    is_training=True,
                                    drop_last=True,
                                    **kwargs)
    
    dataloader_val = create_loader(KittiOd_Dataset(kitti_root, kitti_split='test', **kwargs),
                                    shuffle=False,
                                    is_training=False,
                                    drop_last=False,
                                    **kwargs)
